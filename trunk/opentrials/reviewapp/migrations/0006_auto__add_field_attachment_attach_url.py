...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Attachment.attach_url'
        db.add_column('reviewapp_attachment', 'attach_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attachment.attach_url'
        db.delete_column('reviewapp_attachment', 'attach_url')
