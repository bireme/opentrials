...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Submission._deleted'
        db.add_column('reviewapp_submission', '_deleted', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Submission._deleted'
        db.delete_column('reviewapp_submission', '_deleted')
