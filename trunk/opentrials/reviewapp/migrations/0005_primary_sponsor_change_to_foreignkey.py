...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Submission', fields ['primary_sponsor']
        db.delete_unique('reviewapp_submission', ['primary_sponsor_id'])

        # Changing field 'Submission.primary_sponsor'
        db.alter_column('reviewapp_submission', 'primary_sponsor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.Institution'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Submission.primary_sponsor'
        db.alter_column('reviewapp_submission', 'primary_sponsor_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['repository.Institution'], unique=True, null=True))

        # Adding unique constraint on 'Submission', fields ['primary_sponsor']
        db.create_unique('reviewapp_submission', ['primary_sponsor_id'])
