...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('reviewapp_submission', (
            ...
            ('fields_status', self.gf('django.db.models.fields.TextField')(max_length=512, null=True, blank=True)),
        ...
        db.create_table('reviewapp_remark', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='opened', max_length=16)),
        ))
    ...
    models = {
        ...
        'reviewapp.remark': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'opened'", 'max_length': '16'}),
            'submission': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['reviewapp.Submission']"}),
            'text': ('django.db.models.fields.TextField', [], {'max_length': '2048'})
        },
