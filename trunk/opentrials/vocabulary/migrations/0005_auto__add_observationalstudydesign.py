...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ObservationalStudyDesign'
        db.create_table('vocabulary_observationalstudydesign', (
        ...
        db.send_create_signal('vocabulary', ['ObservationalStudyDesign'])


    def backwards(self, orm):
        
        # Deleting model 'ObservationalStudyDesign'
        db.delete_table('vocabulary_observationalstudydesign')
