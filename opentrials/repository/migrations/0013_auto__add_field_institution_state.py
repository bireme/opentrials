...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Institution.state'
        db.add_column('repository_institution', 'state', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.state'
        db.delete_column('repository_institution', 'state')
    ...
    models = {
        ...
        'repository.institution': {
            ...
            'state': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'})
        },
        'repository.outcome': {
