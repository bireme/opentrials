...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('repository_institution', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Institution.city'
        db.delete_column('repository_institution', 'city')
