...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ApprovedMessage'
        db.delete_table('vocabulary_approvedmessage')

        # Adding model 'MailMessage'
        db.create_table('vocabulary_mailmessage', (
        ...
        db.send_create_signal('vocabulary', ['MailMessage'])


    def backwards(self, orm):
        
        # Adding model 'ApprovedMessage'
        db.create_table('vocabulary_approvedmessage', (
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True)),
            ('description', self.gf('django.db.models.fields.TextField')(max_length=2000, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('vocabulary', ['ApprovedMessage'])

        # Deleting model 'MailMessage'
        db.delete_table('vocabulary_mailmessage')
    ...
    models = {
        ...
        'vocabulary.mailmessage': {
            'Meta': {'ordering': "['order']", 'object_name': 'MailMessage'},
            'description': ('django.db.models.fields.TextField', [], {'max_length': '2000', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
